 ...
 * @author Usuario
 */
public class login_yakner extends javax.swing.JFrame {

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(login_yakner.class.getName());

    /**
     * Creates new form login_yakner
     */
    public login_yakner() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("credenciales del usuario"));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(usuario.equals("yakner")&& contraseña.equals("123456")){
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new login_yakner().setVisible(true));
